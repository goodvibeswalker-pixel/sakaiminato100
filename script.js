...
const themeDetails = {
  ...
  welfare: {
    ...
    sections: [
      ...
      { heading: "主な連絡先・場所", items: ["境港市地域包括支援センター: 境港市役所1階。住所は鳥取県境港市上道町3000。市役所内のため、市役所からの移動時間は徒歩0分です。", "相談・医療介護連携: 福祉保健部 長寿社会課 地域包括支援センター。電話 0859-47-1131、FAX 0859-47-2120、メール choju@city.sakaiminato.lg.jp。", "市役所代表: 〒684-8501 鳥取県境港市上道町3000。電話 0859-44-2111、FAX 0859-44-3001。", "休日の軽い症状: 境港日曜休日応急診療所。電話 0859-44-4173。日曜・祝日などの午前10時-12時、午後1時30分-5時に案内されています。受診前の電話確認が必要です。", "重い症状や専門的治療: 鳥取県西部地域では輪番制の救急医療情報を確認します。緊急時は119番通報を優先します。", "移動支援: 予約型乗合バス「みなとーる」は午前7時-午後8時に運行し、運賃は大人・小児100円、障がい者・介助者50円。予約状況に応じてAIがルートを作成します。"] },
